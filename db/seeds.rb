...
Student.create(first_name: "Scarlett", last_name: "Perry", gender: "F", ethnicity: "Latinx", dob: Date.new(1997, 10, 5), financial_aid: false, major_id: 1, username: "scarlett", password: "perry")
